...
switch(donald->number)
{
	case 0 ://prima era x=19 y=43 e 1 e 150
		...
		gotoxybeg(donald->x, donald->y, -45.0, 190.0,donald->sn,donald->dx,donald->max_speed,donald->sn_sonar, donald->sn_compass, donald->sn_mag, donald->teta);
		...
		gotoxybeg(donald->x, donald->y, -10, 345.0,donald->sn,donald->dx,donald->max_speed,donald->sn_sonar, donald->sn_compass, donald->sn_mag, donald->teta);
		//rotatedx of 180
		//leave the ball
		//send ball position
		//rotatesx 180
